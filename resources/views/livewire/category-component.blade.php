                ...
                <div class="col-12 mb-4">
                    <div class="section-title d-flex justify-content-between align-items-center mb-3">
                        <h4 class="m-0 text-uppercase font-weight-bold">
                            Category: {{ optional($allCategories->firstWhere('id', $selectedCategory))->name ?? 'Select a Category' }}
                        </h4>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 mb-4">
                        <div class="box shadow-sm border rounded p-3 h-100">
                            ...
                            <div class="d-flex justify-content-between mb-2">
                                <span class="badge badge-warning text-uppercase p-2">{{ optional($post->category)->name ?? 'Uncategorized' }}</span>
